...
<head>
    ...
    <link rel="stylesheet" href="AdminTransactionRecord.css">
...
<div class="qrscanner_btn">
    ...
    <div class="TransactHistory">
        <input type="button" value="History" onclick="window.location.href='AdminTransactionRecordHistory.php'">
    </div>
                ...
                <br>
                    ...
                    <?php
                        ...
                        <br> -->
                            ...
                            // Display the initial QR code text when the page loads
